...
function selectWinner() {
    ...
    if (isWinner) {
        ...
        setTimeout(() => {
            ...
            wonText.innerHTML = `<span style="font-size:40px;"></span><p> Player ${playerSign} won the game! <p><span style="font-size:40px;"></span>`;
            wonText.classList.add("winner-animate");
            setTimeout(() => {
                wonText.classList.remove("winner-animate");
            }, 1200);
        }, 700);
        ...
        setTimeout(() => {
            resultBox.classList.add("show");
            playBoard.classList.remove("show");
            wonText.innerHTML = `<span style="font-size:32px;">🤝</span> Match has been drawn!`;
        }, 700);
    }
}
